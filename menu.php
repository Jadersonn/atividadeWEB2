...
<nav class="navbar navbar-expand-lg bg-body-tertiary mt-3">
    <div class="container-fluid">
        <img src="<?php echo $path; ?>/arquivos/imagens/ifmscb.png" width="11%">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            ...
            <form class="d-flex" role="search">
                <?php if(isset($_SESSION['status'])==true){
                    ?><a class="btn btn-outline-primary me-2" id="linkDeslogar" href="<?php echo $path; ?>/repositorio/login/deslogar.php">Deslogar</a>
                    <?php }else{?>
                    <a class="btn btn-outline-primary" id="linkLogar" href="<?php echo $path; ?>/view/login/logar.php">Logar</a><?php };    ?>
